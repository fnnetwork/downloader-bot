    ...
    'inline_keyboard' => [
        [
            [
                ...
                'url' => "https://t.me/fn_network_back"
            ]
        ]
    ]
];
...
function sendInitialSongDetails($chat_id, $song_data, $track_index) {
    ...
    $message = "🎼 Nᴀᴍᴇ: $track_name\n👨‍🎨 Aʀᴛɪsᴛ: $artist\n✨ Aʟʙᴜᴍ: $album <a href='$image_url'>ㅤ</a>";
...
if ($text == "/start") {
    ...
    $welcome_message = "👑 <b>Wᴇʟᴄᴏᴍᴇ, Yᴏᴜʀ Hɪɢʜɴᴇss!</b> 👑\n\n"
        . "🎶 I'ᴍ <b>@MUSIC_E_DOWNLOADER_BOT</b>, your royal assistant for all things music! 🎧\n\n"
    ...
    $keyboard = [
        'inline_keyboard' => [
            [['text' => "📢 Updates Channel", 'url' => "https://t.me/fn_network_back"]]
        ]
    ];
    ...
    if ($session_data) {
        ...
        if ($callback_data == "next" && $track_index < count($song_data['tracks']) - 1) {
            ...
            if ($download_link) {
                $caption = "*🎶 Music downloaded by @MUSIC_E_DOWNLOADER_BOT 🎵*\n\n_Enjoy your Beats 🎧_";
